...
import static com.avaliacaoteste.domain.AlunoAsserts.*;
...
import com.avaliacaoteste.domain.Aluno;
import com.avaliacaoteste.repository.AlunoRepository;
...
class AlunoResourceIT {
    ...
    public static Aluno createEntity() {
        return new Aluno().nome(DEFAULT_NOME).email(DEFAULT_EMAIL).telefone(DEFAULT_TELEFONE);
    }
    ...
    public static Aluno createUpdatedEntity() {
        return new Aluno().nome(UPDATED_NOME).email(UPDATED_EMAIL).telefone(UPDATED_TELEFONE);
    }
    ...
    void putExistingAluno() throws Exception {
        ...
        updatedAluno.nome(UPDATED_NOME).email(UPDATED_EMAIL).telefone(UPDATED_TELEFONE);
    ...
    void partialUpdateAlunoWithPatch() throws Exception {
        ...
        partialUpdatedAluno.nome(UPDATED_NOME).telefone(UPDATED_TELEFONE);
