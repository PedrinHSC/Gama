...
describe('Aluno e2e test', () => {
  ...
  const alunoSample = { nome: 'duh', email: 'Eloa34@yahoo.com' };
  ...
  describe('new Aluno page', () => {
    ...
    it('should create an instance of Aluno', () => {
      cy.get(`[data-cy="nome"]`).type('teeming foolishly welcome');
      cy.get(`[data-cy="nome"]`).should('have.value', 'teeming foolishly welcome');

      cy.get(`[data-cy="email"]`).type('Roberto.Nogueira10@yahoo.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Roberto.Nogueira10@yahoo.com');

      cy.get(`[data-cy="telefone"]`).type('bravely even');
      cy.get(`[data-cy="telefone"]`).should('have.value', 'bravely even');
