...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '7313f5a0-8587-4b0e-a8ac-bef5f3514133' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('3fc94323-6b59-4806-b09b-98612e569441');
      cy.get(`[data-cy="name"]`).should('have.value', '3fc94323-6b59-4806-b09b-98612e569441');
